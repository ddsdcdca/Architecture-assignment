...
class TestCrosstalk(QiskitTestCase):
    ...
    def test_schedule_length1(self):
        ...
        # 新增打印输出
        print("Test 1 - High Crosstalk:")
        print("Scheduled Depth:", scheduled_dag.depth())
    ...
    def test_schedule_length3(self):
        ...
        # 新增打印输出
        print("Test 3 - Repeated Calls:")
        print("Scheduled Depth on First Run:", scheduled_dag1.depth())
        print("Scheduled Depth on Second Run:", scheduled_dag2.depth())
